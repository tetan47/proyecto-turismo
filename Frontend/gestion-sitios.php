...
<head>
    ...
    <title>Gestionar Sitios Turísticos</title>
...
<section class="catalogo" id="catalogo-eventos">
    <h2 style="text-align:center; padding:1em;">Cargando sitios turísticos...</h2>
</section>
...
function cargarSitios() {
    ...
    fetch("../backend/administrador/gestionsitio.php", {
        method: 'GET'
    })
    .then(res => {
        if (!res.ok) {
    ...
    .catch(error => {
        ...
        catalogo.innerHTML = '<p style="padding:2em;text-align:center;color:red;">Error al cargar los sitios. Verifica la conexión.</p>';
    });
}
</script>
</body>
