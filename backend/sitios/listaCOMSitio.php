...
if ($sitio_id > 0) {
    ...
    if ($result->num_rows > 0) {
            ...
            <div class="comentarios" id="comentario_<?php echo $row['ID_Comentario']; ?>">
                ...
                <div class="info-comentarios">
                        ...
                        <?php if ($esPropietario): ?>
                            <div class="menu-coment">
                                ...
                                <div class="menu-contenido" id="opciones_<?php echo $row['ID_Comentario']; ?>" style="display:none;">
                                    <button
                                        onclick="mostrarEditor(<?php echo $row['ID_Comentario']; ?>, `<?php echo addslashes($row['Texto']); ?>`)">Editar</button>
                                    <hr>
                    ...
                    <div id="editor_comentario_<?php echo $row['ID_Comentario']; ?>" style="display:none;">
                        <textarea id="texto_edicion_<?php echo $row['ID_Comentario']; ?>"
                            style="width:100%;"><?php echo htmlspecialchars($row['Texto']); ?></textarea>
                    ...
                    <div class="footer-comentarios">
                        ...
                        <button type="button" class="responder"
                            onclick="mostrarFormularioRespuesta(<?php echo $row['ID_Comentario']; ?>)">Responder</button>

                        <label class="cora <?php echo ($liked ? "liked" : "");
                        echo (!$usuario_logueado ? " disabled" : ""); ?>"
                            ...
                            <div class="comentarios respuesta" id="respuesta_<?php echo $respuesta['comentario_responder']; ?>">
                                ...
                                <div class="info-comentarios">
                                        ...
                                        <?php if ($esPropietarioRespuesta): ?>
                                            <div class="menu-coment">
                                                <button class="menu-btn"
                                                    onclick="toggleMenuRes(<?php echo $respuesta['comentario_responder']; ?>)">⋮</button>
                                                <div class="menu-contenido"
                                                    id="opciones_res_<?php echo $respuesta['comentario_responder']; ?>"
                                                    style="display:none;">
                                                    <button
                                                        onclick="mostrarEditorRes(<?php echo $respuesta['comentario_responder']; ?>, `<?php echo addslashes($respuesta['respuesta']); ?>`)">Editar</button>
                                                    <hr>
                                                    <button
                                                        onclick="eliminarRespuesta(<?php echo $respuesta['comentario_responder']; ?>)">Eliminar</button>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div id="editor_respuesta_<?php echo $respuesta['comentario_responder']; ?>" style="display:none;">
                                        <textarea id="texto_edicion_res_<?php echo $respuesta['comentario_responder']; ?>"
                                            style="width:100%;"><?php echo htmlspecialchars($respuesta['respuesta']); ?></textarea>
                                        <div style="margin-top:10px;">
                                            <button
                                                onclick="guardarEdicionRespuesta(<?php echo $respuesta['comentario_responder']; ?>)">Guardar</button>
                                            <button
                                                onclick="cancelarEdicionRespuesta(<?php echo $respuesta['comentario_responder']; ?>)">Cancelar</button>
                                        </div>
                                    </div>
                    ...
                    <?php if ($usuario_logueado): ?>
                        <div class="formulario-respuesta" id="form_respuesta_<?php echo $row['ID_Comentario']; ?>"
                            style="display:none;">
                            <textarea id="texto_respuesta_<?php echo $row['ID_Comentario']; ?>" placeholder="Escribe tu respuesta..."
        ...
        <div style="padding:1em;text-align:center;color:#555;">
            <p>No hay comentarios para este sitio.</p>
        </div>
    <?php
    }
    $stmt->close();
