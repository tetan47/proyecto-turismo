...
<section class="catalogo" id="catalogo-usuarios">
    <h2 style="text-align:center; padding:1em;">Cargando usuarios...</h2>
</section>
...
function cargarUsuarios() {
    const catalogo = document.getElementById('catalogo-usuarios');
    
    fetch("../backend/administrador/gestionusuario.php", {
        method: 'GET'
    })
    .then(res => {
        if (!res.ok) {
    ...
    .catch(error => {
        ...
        catalogo.innerHTML = '<p style="padding:2em;text-align:center;color:red;">Error al cargar los usuarios. Verifica la conexión.</p>';
    });
}
</script>
</body>
